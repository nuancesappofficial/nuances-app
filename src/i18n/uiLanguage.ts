...
const STRINGS: Record<'en' | 'zh-TW' | 'zh-CN', Record<UIStringKey, string>> = {
  en: {
    ...
    'deck.tourCompleteTitle': 'Save without opening the app',
  ...
  'zh-TW': {
    ...
    'deck.alertCancel': '取消',
    'deck.alertDelete': '刪除',
    'deck.tourCompleteTitle': '不開app就能儲存',
    ...
    'settings.membership.badge.save': '熱門',
    ...
    'pronunciation.status.mappingPhonemes': '正在對齊音標...',
    ...
    'pronunciation.showAllSounds': '顯示所有音標',
    'pronunciation.showFewerSounds': '收合音標',
  ...
  'zh-CN': {
    ...
    'deck.alertCancel': '取消',
    'deck.alertDelete': '删除',
    'deck.tourCompleteTitle': '不打开app就能储存',
    ...
    'settings.membership.badge.save': '热门',
    ...
    'pronunciation.status.mappingPhonemes': '正在对齐音标...',
    ...
    'pronunciation.showAllSounds': '显示所有音标',
    'pronunciation.showFewerSounds': '收起音标',
