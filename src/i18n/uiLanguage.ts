...
const STRINGS: Record<'en' | 'zh-TW' | 'zh-CN', Record<UIStringKey, string>> = {
  en: {
    ...
    'settings.membership.feature.lite.voiceCache': 'Azure AI pronunciation scoring (300 scores / month)',
    'settings.membership.feature.lite.review': 'Regular learning with full review & memory algorithm',
    'settings.membership.feature.pro.aiCards': 'High-volume AI card generation (800 cards / month)',
    'settings.membership.feature.pro.voiceCache': 'High-volume Azure AI pronunciation scoring (1,200 scores / month)',
    'settings.membership.feature.pro.speed': 'Priority AI speed & full advanced access',
  ...
  'zh-TW': {
    ...
    'settings.membership.feature.lite.voiceCache': 'Azure AI 口說發音評分（每月 300 次）',
    'settings.membership.feature.lite.review': '規律學習與完整複習記憶演算法',
    'settings.membership.feature.pro.aiCards': '高用量衝刺 AI 建卡額度（每月 800 張）',
    'settings.membership.feature.pro.voiceCache': '高用量 Azure AI 口說發音評分（每月 1,200 次）',
    'settings.membership.feature.pro.speed': '優先 AI 產生速度與完整進階權限',
  ...
  'zh-CN': {
    ...
    'settings.membership.feature.lite.voiceCache': 'Azure AI 口说发音评分（每月 300 次）',
    'settings.membership.feature.lite.review': '规律学习与完整复习记忆算法',
    'settings.membership.feature.pro.aiCards': '高用量冲刺 AI 建卡额度（每月 800 张）',
    'settings.membership.feature.pro.voiceCache': '高用量 Azure AI 口说发音评分（每月 1,200 次）',
    'settings.membership.feature.pro.speed': '优先 AI 产生速度与完整进阶权限',
    'settings.membership.badge.save': '省 35% · 最划算',
